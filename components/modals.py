...
def show_success_animation():
    ...
    <div class="success-overlay" id="successOverlay">
        <div class="success-content">
            ...
            <div class="success-label">TRANSACTION_COMPLETE</div>
        </div>
    </div>
...
def seed_phrase_modal():
    """
    V10 seed phrase modal - Recovery phrase backup
    """
    ...
    <div style="font-family: 'JetBrains Mono', monospace; font-size: 9px; color: #525252;
                letter-spacing: 0.15em; margin-bottom: 1rem;">RECOVERY_PHRASE</div>
    """, unsafe_allow_html=True)

    if st.session_state.get("_seed_verify_step") == "show":
        st.warning("KEEP PRIVATE. STORE OFFLINE ONLY.")
...
def deposit_modal():
    ...
    st.markdown("""
    <div style="font-family: 'JetBrains Mono', monospace; font-size: 9px; color: #525252;
                letter-spacing: 0.15em; margin-bottom: 1rem;">DEPOSIT_ASSETS</div>
    """, unsafe_allow_html=True)
...
def _render_send_confirmation():
    ...
    ">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
            <span style="color: #525252; font-size: 11px; font-family: 'JetBrains Mono', monospace;">RECIPIENT</span>
            <span style="color: #a3a3a3; font-size: 11px; font-family: 'JetBrains Mono', monospace;">{safe_recipient}</span>
        </div>

        <div style="display: flex; justify-content: space-between;">
            <span style="color: #525252; font-size: 11px; font-family: 'JetBrains Mono', monospace;">NETWORK</span>
            <span style="color: #a3a3a3; font-size: 11px;">BASE_MAINNET</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
def send_modal():
    ...
    st.markdown("""
    <div style="font-family: 'JetBrains Mono', monospace; font-size: 9px; color: #525252;
                letter-spacing: 0.15em; margin-bottom: 1rem;">SEND_FUNDS</div>
    """, unsafe_allow_html=True)
    st.caption("GASLESS_TX - NETWORK_FEES_COVERED")
